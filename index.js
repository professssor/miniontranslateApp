...
var inputData = document.querySelector("#inputfield");
var button = document.querySelector("button");
var outputData = document.querySelector("#second");
...
function resolveApiData() {
  ...
  fetch(generateUrl(enteredText))
    ...
    .then((data) => {
      var minionLanguage = data.contents.translated;
      outputData.innerText = minionLanguage;
      console.log(minionLanguage);
    })
    .catch(errorHandler);
}
